    ...
    <section class="about" id="about">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-sm-offset-3 kiri">
             <h3>Dicoding</h3>
             <p>Progressive Web App (PWA) developer 2020</p> 
          </div>
          <div class="col-sm-3 kanan">
            <h3>LINE</h3>
            <p>Line Front-End Framework (LIFF : API) developer 2020</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        ...
        <div class="row">
		    ...
		    <div class="col-md-5 col-sm-offset-2 thumbnail">
          ...
          <div class="col-sm-4 col-sm-offset-1">
            ...
            <div class="card bg-primary text-white mb-4 text-center">
              <div class="card-body pt-1 pb-1">
                ...
                <p class="card-text">
                I am usually worker as remote. But, you can</p> <p>also find me at this geological location.</p>
              </div>
          </div>
          <br>
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">Jl. Padat Karya, No Q.11, Prabumulih</li>
